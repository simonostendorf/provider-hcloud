...
PROJECT_REPO ?= github.com/simonostendorf/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 1.48.1
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-hcloud
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-hcloud_v1.48.1
